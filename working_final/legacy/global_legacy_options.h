...
OPTION(leveldb_write_buffer_size, OPT_SIZE)
OPTION(leveldb_cache_size, OPT_SIZE)
OPTION(leveldb_block_size, OPT_SIZE)
OPTION(leveldb_bloom_size, OPT_INT)
OPTION(leveldb_max_open_files, OPT_INT)
OPTION(leveldb_compression, OPT_BOOL)
OPTION(leveldb_paranoid, OPT_BOOL)
OPTION(leveldb_log, OPT_STR)
